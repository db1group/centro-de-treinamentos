# Competência: Codificador mestre
...
1. [[Curso] Design Patterns em Java I: Introdução às boas práticas de programação](https://www.alura.com.br/curso-online-introducao-design-patterns-java)
...
1. [[Curso] Escola HTML e CSS](https://www.alura.com.br/cursos-online-front-end/html-css)
...
1. [[Leitura] Refactoring - Code Smells](https://refactoring.guru/pt-br/refactoring/smells)
...
### Objetivo: Aprender como detectar vulnerabilidades em softwares (Nível 4)
#### PENTEST
...
#### Cobertura de código
1. [Dica] Cobertura de código é um indicador em porcentagem da quantidade de código de produção de um sistema que foi chamado no momento que a suíte de testes foi executada
#### TDD
1. [Dica] Sigla para Test Driven Development, o TDD é uma metologia de escrita de sistemas em que o foco é a testabilidade, chegando inclusive na máxima em que os testes são escritos antes mesmo da existência dos códigos que testarão
#### BDD
1. [[Dica] BDD é uma técnica de desenvolvimento que visa aproximar as áreas de negócio e técnicas, utilizando de uma linguagem formal mais alto nível para a escrita dos comportamentos](https://pt.wikipedia.org/wiki/Behavior_Driven_Development)
### Objetivo: Implementar testes automatizados avançados (Nível 3)
#### Utilização de repositórios em memória
1. [Dica] Ao executar testes automatizados de integração, pode ser necessária a utilização de armazenamento de dados e, dada a complexidade de instalação e o consumo de recursos, é possível simular esse armazenamento em memória. Há bibliotecas e técnicas para a correta utilização deste conceito
#### Testes de integração
1. [Dica] Teste de integração é qualquer teste que interaja mais de um componente de software, isto é, engloba mais recursos que um teste de unidade. O aprendizado de técnicas relacionadas a testes de integração trará benefícios na escrita e desempenho de testes de um sistema
1. [[Áudio/Vídeo] Testes automatizados com Cucumber + HTTParty](https://www.youtube.com/watch?v=xlptiFRsEv0)
1. [[Áudio/Vídeo] Cucumber não é BDD](https://www.youtube.com/watch?v=VHo9SHJiISY#https://www.youtube.com/watch?v=VHo9SHJiISY)
#### E2E
1. [Dica] Acrônimo para End to End, o E2E é um tipo de teste automatizado que verifica a integração completa de um sistema, no caso mais comum este teste fará a interação com a interface do usuário que estará conectada com todos os componentes reais até o sistema de armazenamento
# Competência: Relevância técnica
## Trilha: Referência técnica
### Objetivo: Conhecer banco de dados relacionais, sendo capaz de realizar operações de escrita e leitura (Nível 1)
#### Dominar comandos DDL e DML
1. [Dica] Siglas para Data Definition Language e Data Manipulation Language, DDL e DML definem instruções para administração de metadados e dados respectivamente, isto é, DDL define estruturas e DML manipula dados dentro dessas estruturas
#### Controle transacional e conceito de atomicidade
1. [Dica] Atomicidade é um conceito de bancos de dados que descreve o agrupamento de múltiplas operações que devem ocorrer de forma indivisível: ou todas funcionam ou todas falham. O controle transacional é o meio pelo qual transações atômicas são gerenciadas
#### Entender como funcionam índices e constraints
1. [Dica] Em bancos de dados relacionais, índices são estruturas que otimizam a busca dos dados e as constraints são regras que os programadores podem definir para garantir a consistência de dados
#### Aprender sobre ferramentas para elaboração de diagramas de entidades e relacionamentos
1. [Dica] As entidades e os relacionamentos entre elas nos bancos de dados costumam ser demonstradas por meio de diagramas. Existem inúmeras ferramentas que possibilitam desenhar essa representação
#### SQL Joins
1. [Dica] Ao fazer uma consulta em um banco de dados, a união entre tabelas pode ser feita de várias formas formas conhecidas como JOINS. Cada qual tem sua peculiaridade do tipo de resultado fornecido
#### Conhecer ACID
1. [Dica] ACID é um acrônimo para Atomicidade, Consistência, Isolamento e Durabilidade que são propriedades de transações de bancos de dados
### Objetivo: Conhecer técnicas avançadas de prototipação e desenvolvimento de frontends web (Nível 1)
...
1. [[Curso] Primeiros Passos no Linux - Conceitos e Principais Comandos](https://www.udemy.com/course/primeiros-passos-no-linux/)
...
1. [Dica] As documentações, apesar de sua utilização mais comum como referência para dúvidas, é onde as informações são mais precisas e em nível mais detalhado
...
1. [Dica] É comum a centralização de conhecimento em pessoas específicas pelos mais diversos motivos. Essa ocorrência pode gerar alta dependência e, por isso, alto risco. É esperado que esta centralização seja detectada e a distribuição do conhecimento e responsabilidades seja feita o mais rápido possível
...
#### Mentorar colegas no programa de mentoria da empresa
...
### Objetivo: Participar ativamente dos objetivos estratégicos do projeto em que atua (Nível 3)
...
### Objetivo: Entender e modelar as soluções para os problemas do cliente (Nível 2)
#### Design Thinking
...
#### Entender o papel do cliente no cenário em que ele está inserido
